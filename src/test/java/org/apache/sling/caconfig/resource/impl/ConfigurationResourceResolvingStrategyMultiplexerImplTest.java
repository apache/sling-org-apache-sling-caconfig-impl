...
public class ConfigurationResourceResolvingStrategyMultiplexerImplTest {
    ...
    public void testWithDefaultStrategy() {
        ...
        assertThat(
                underTest.getResource(site1Page1, BUCKETS, "test"),
                ResourceMatchers.path("/conf/site1/sling:test/test"));
        assertThat(
                underTest.getResourceCollection(site1Page1, BUCKETS, "feature"),
        ...
        assertThat(
                first(underTest.getResourceInheritanceChain(site1Page1, BUCKETS, "test")),
                ResourceMatchers.path("/conf/site1/sling:test/test"));
        assertThat(
                first(underTest.getResourceCollectionInheritanceChain(site1Page1, BUCKETS, "feature")),
                ResourceCollectionMatchers.paths(
                        "/conf/site1/sling:test/feature/c",
                        "/apps/conf/sling:test/feature/a",
                        "/libs/conf/sling:test/feature/b"));
    ...
    public void testMultipleStrategies() {
        ...
        context.registerService(
                ConfigurationResourceResolvingStrategy.class,
        ...
        assertThat(
                underTest.getResourceCollection(site1Page1, BUCKETS, "feature"),
                ResourceCollectionMatchers.paths("/conf/site1/sling:test/feature/c"));
