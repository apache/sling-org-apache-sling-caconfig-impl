...
public class ConfigurationManagerImplTest {
    ...
    public void setUp() throws Exception {
        ...
        contextResourceLevel2 =
                context.create().resource("/content/test/level2", PROPERTY_CONFIG_REF, "/conf/test/level2");
        contextResourceLevel3 = context.create()
                .resource("/content/test/level2/level3", PROPERTY_CONFIG_REF, "/conf/test/level2/level3");
        contextResourceNoConfig =
                context.create().resource("/content/testNoConfig", PROPERTY_CONFIG_REF, "/conf/testNoConfig");

        context.create()
                .resource(
                        getConfigResolvePath("/conf/test/sling:configs/" + CONFIG_NAME),
                        "prop1",
                        "value1",
                        "prop4",
                        true);
        ...
        context.create()
                .resource(
                        getConfigCollectionItemResolvePath(getConfigCollectionParentResolvePath(
        ...
        context.create()
                .resource(
                        getConfigResolvePath("/conf/test/level2/level3/sling:configs/" + CONFIG_NAME),
                        "prop4",
                        false,
                        "prop5",
                        "value5_level3",
        ...
        context.create()
                .resource(
                        getConfigCollectionParentResolvePath(
        ...
        context.create()
                .resource(
                        getConfigResolvePath("/conf/test/level2/sling:configs/" + CONFIG_NESTED_NAME),
                        "prop1",
                        "value1",
                        "prop4",
                        true);
        context.create()
                .resource(
                        getConfigResolvePath(
                                getConfigResolvePath("/conf/test/sling:configs/" + CONFIG_NESTED_NAME) + "/propSub"),
                        "prop1",
                        "propSubValue1",
                        "prop4",
                        true);
        context.create()
                .resource(
                        getConfigResolvePath(getConfigResolvePath(
                                        getConfigResolvePath("/conf/test/sling:configs/" + CONFIG_NESTED_NAME)
                                                + "/propSub")
                                + "/propSubLevel2"),
                        "prop1",
                        "propSubLevel2Value1",
        ...
        context.create()
                .resource(
                        getConfigResolvePath(getConfigCollectionItemResolvePath(getConfigCollectionParentResolvePath(
                                                getConfigResolvePath("/conf/test/sling:configs/" + CONFIG_NESTED_NAME)
                                                        + "/propSubList")
                                        + "/item1")
                                + "/propSub"),
                        "prop1",
                        "propSubList1_proSubValue1",
                        "prop4",
                        true);
        ...
        ConfigurationMetadata propSubMetadata = new ConfigurationMetadata(
                ...
                List.<PropertyMetadata<?>>of(
                        ...
                        new PropertyMetadata<>("prop2", String.class),
                        new PropertyMetadata<>("prop3", 5),
                        new PropertyMetadata<>("propSubLevel2", ConfigurationMetadata.class)
                                .configurationMetadata(propSubLevel2Metadata)),
                false);
        ...
        ConfigurationMetadata configNestedMetadata = new ConfigurationMetadata(
                ...
                List.<PropertyMetadata<?>>of(
                        ...
                        new PropertyMetadata<>("propSub", ConfigurationMetadata.class)
                                .configurationMetadata(propSubMetadata),
                        new PropertyMetadata<>("propSubList", ConfigurationMetadata[].class)
                                .configurationMetadata(propSubListMetadata)),
                false);
        when(configurationMetadataProvider.getConfigurationMetadata(CONFIG_NESTED_NAME))
    ...
    public void testGetConfiguration_WithOverride() {
        context.registerService(
                ...
                new DummyConfigurationOverrideProvider("[/content]" + CONFIG_NAME + "={\"prop1\":\"override1\"}"));
    ...
    public void testGetConfigurationCollection() {
        ...
        assertNull(configCollectionData
                .getProperties()
                .get(ConfigurationResourceNameConstants.PROPERTY_CONFIG_COLLECTION_INHERIT));
    }
    ...
    public void testGetConfigurationCollection_WithResourceCollectionInheritance() {
        ...
        String configPath1 = getConfigCollectionItemResolvePath(
                getConfigCollectionParentResolvePath("/conf/test/level2/sling:configs/" + CONFIG_COL_NAME) + "/1");
        assertFalse(configData1.getValueInfo("prop1").isInherited());
        ...
        String configPath2 = getConfigCollectionItemResolvePath(
                getConfigCollectionParentResolvePath("/conf/test/sling:configs/" + CONFIG_COL_NAME) + "/2");
        ...
        assertTrue((Boolean) configCollectionData
                .getProperties()
                .get(ConfigurationResourceNameConstants.PROPERTY_CONFIG_COLLECTION_INHERIT));
    }
    ...
    public void testGetConfigurationCollection_WithResourceCollectionAndPropertyInheritance() {
        ...
        String configPathLevel2 = getConfigCollectionItemResolvePath(
                getConfigCollectionParentResolvePath("/conf/test/level2/sling:configs/" + CONFIG_COL_NAME) + "/1");
        String configPathLevel3 = getConfigCollectionItemResolvePath(
    ...
    public void testPersistConfigurationCollection() throws Exception {
        ...
        String configPath0 = getConfigCollectionItemPersistPath(
                getConfigCollectionParentPersistPath("/conf/testNoConfig/sling:configs/" + CONFIG_COL_NAME) + "/0");
        ValueMap props0 = context.resourceResolver().getResource(configPath0).getValueMap();
        assertEquals("value1", props0.get("prop1"));

        String configPath1 = getConfigCollectionItemPersistPath(
                getConfigCollectionParentPersistPath("/conf/testNoConfig/sling:configs/" + CONFIG_COL_NAME) + "/1");
        ValueMap props1 = context.resourceResolver().getResource(configPath1).getValueMap();
        assertEquals(5, props1.get("prop2"));

        ConfigurationCollectionData colData =
                underTest.getConfigurationCollection(contextResourceNoConfig, CONFIG_COL_NAME);
    ...
    public void testGetConfigurationConfigurationMetadata() {
        assertEquals(
                CONFIG_NAME, underTest.getConfigurationMetadata(CONFIG_NAME).getName());
    }
    ...
    public void testGetConfigurationNested() {
        ...
        assertTrue(ConfigurationData.class.isAssignableFrom(
                configData.getValueInfo("propSub").getValue().getClass()));
        assertTrue(ConfigurationData.class.isAssignableFrom(
                configData.getValueInfo("propSub").getEffectiveValue().getClass()));
        assertTrue(ConfigurationData[]
                .class.isAssignableFrom(
                        configData.getValueInfo("propSubList").getValue().getClass()));
        assertTrue(ConfigurationData[]
                .class.isAssignableFrom(configData
                        .getValueInfo("propSubList")
                        .getEffectiveValue()
                        .getClass()));
        ...
        assertTrue(ConfigurationData.class.isAssignableFrom(
                subData.getValueInfo("propSubLevel2").getValue().getClass()));
        assertTrue(ConfigurationData.class.isAssignableFrom(
                subData.getValueInfo("propSubLevel2").getEffectiveValue().getClass()));
        ...
        ConfigurationData subListDataItem1SubEffecive =
                subListData[0].getEffectiveValues().get("propSub", ConfigurationData.class);
    ...
    public void testGetConfigurationMetadata_Nested_Sub() {
        ConfigurationMetadata configMetadataSub =
                underTest.getConfigurationMetadata(getConfigResolvePath(CONFIG_NESTED_NAME) + "/propSub");
    ...
    public void testGetConfigurationMetadata_Nested_SubLevel2() {
        ConfigurationMetadata configMetadataSubLevel2 = underTest.getConfigurationMetadata(
    ...
    public void testGetConfigurationMetadata_Nested_SubList() {
        ConfigurationMetadata configMetadataSubList =
                underTest.getConfigurationMetadata(getConfigResolvePath(CONFIG_NESTED_NAME) + "/propSubList");
    ...
    public void testGetConfigurationMetadata_Nested_SubList_Sub() throws Exception {
        // delete resource already existing in test fixture to test with non-existing resource but existing collection
        // item as parent
        context.resourceResolver()
                .delete(context.resourceResolver()
                        .getResource(getConfigResolvePath(getConfigCollectionItemResolvePath(
                                        getConfigCollectionParentResolvePath(getConfigResolvePath(
                                                                "/conf/test/sling:configs/" + CONFIG_NESTED_NAME)
                                                        + "/propSubList")
                                                + "/item1")
                                + "/propSub")));

        ConfigurationMetadata subListDataItem1Sub = underTest.getConfigurationMetadata(
                getConfigCollectionItemResolvePath(getConfigCollectionParentResolvePath(
    ...
    public void testGetConfigurationMetadata_Nested_SubList_SubLevel2() throws Exception {
        ...
        ConfigurationMetadata subListDataItem1SubLevel2 = underTest.getConfigurationMetadata(
                getConfigResolvePath(getConfigCollectionItemResolvePath(getConfigCollectionParentResolvePath(
                                                getConfigResolvePath(CONFIG_NESTED_NAME) + "/propSubList")
                                        + "/item1")
                                + "/propSub")
    ...
    public void testNewCollectionItem_Nested_SubList() {
        ConfigurationData configData =
                underTest.newCollectionItem(contextResource, getConfigResolvePath(CONFIG_NESTED_NAME) + "/propSubList");
